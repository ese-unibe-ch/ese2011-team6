...
public class ESEUserTest extends UnitTest {
	...
	public void shouldCreatCalendarNewUser() {
		...
		hansi.calendarList.add(ESEFactory.createCalendar("Wichtige Sachen"));// LK
																				// @
																				// TEAM_TEST:
																				// Don't
																				// use
	...
	public void shouldCreatCalendarDBUser() {
		...
		// add by using factory
		bill.calendarList.add(ESEFactory.createCalendar("Wichtige Sachen")); // LK
																				// @
																				// TEAM_TEST:
																				// Don't
																				// use
	...
	public void shouldRemoveCalendarNDBUser() {
		// set up
		ESEUser bob = ESEFactory.createUser("hansi", "sehrgeheim", "Hans",
				"Müller");
	...
	public void shouldCreateGroupNewUser() {
		...
		// add by using Factory
		hansi.groupList.add(ESEFactory.createGroup("best buddies")); // LK @
																		// TEAM_TEST:
																		// Don't
																		// use
																		// it
	...
	public void shouldCreateGroupDBUser() {
		...
		// add by using Factory
		jack.groupList.add(ESEFactory.createGroup("best buddies")); // LK @
																	// TEAM_TEST:
																	// Don't use
																	// it like
																	// this! Use
	...
	public void shouldRemoveGroupeNewUser() {
		...
		ESEUser hansi = ESEFactory.createUser("hansi", "sehrgeheim", "Hans",
				"Müller");
		hansi.groupList.add(ESEFactory.createGroup("studies")); // LK @
																// TEAM_TEST:
																// Don't use it
																// like this!
																// Use the
