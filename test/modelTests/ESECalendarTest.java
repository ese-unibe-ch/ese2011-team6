...
public class ESECalendarTest extends UnitTest {
	...
	@Before
	public void setUp() {
		testCalendar = new ESECalendar("TestCalendarName"); // LK @ TEAM_TEST:
															// Don't
															// use it like this!
															// Use the
															// ESEFactory class
	...
	public void shouldReturnListOfAllEvents() {
		assertTrue(testCalendar.getAllEventsAsList().get(0).name
				.equals("TestEvent1"));
		assertTrue(testCalendar.getAllEventsAsList().get(1).name
				.equals("TestEvent2"));
		assertTrue(testCalendar.getAllEventsAsList().get(2).name
				.equals("TestEvent3"));
	}
	...
	public void shouldReturnListOfAllPublicEvents() {
		...
		assertTrue(testCalendar.getPublicEventsAsList().get(0).name
				.equals("TestEvent1"));
		assertTrue(testCalendar.getPublicEventsAsList().get(1).name
				.equals("TestEvent3"));
	}
